...
Java_com_example_jnisample_StringJni_handlerString(JNIEnv *env, jobject jobj, jstring str_) {
    //utf-8 字符
...
Java_com_example_jnisample_StringJni_handlerStrToByte(JNIEnv *env, jobject jobj, jstring str_) {
